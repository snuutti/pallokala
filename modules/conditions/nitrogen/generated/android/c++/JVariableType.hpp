...
namespace margelo::nitro::NitroConditions {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/conditions/VariableType;";
  ...
  namespace JVariableType_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/conditions/VariableType$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/conditions/VariableType$Second;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/conditions/VariableType$Third;";
